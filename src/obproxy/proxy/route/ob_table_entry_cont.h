...
// ROUTE_EVENT_EVENTS_START = 1000
#define TABLE_ENTRY_LOOKUP_CACHE_EVENT (ROUTE_EVENT_EVENTS_START + 1) /* 1001 */
#define TABLE_ENTRY_LOOKUP_REMOTE_EVENT (ROUTE_EVENT_EVENTS_START + 2) /* 1002 */
#define TABLE_ENTRY_CHAIN_NOTIFY_CALLER_EVENT (ROUTE_EVENT_EVENTS_START + 3) /* 1003 */
#define TABLE_ENTRY_NOTIFY_CALLER_EVENT (ROUTE_EVENT_EVENTS_START + 4) /* 1004 */
#define TABLE_ENTRY_FAIL_SCHEDULE_LOOKUP_REMOTE_EVENT (ROUTE_EVENT_EVENTS_START + 5) /* 1005 */
